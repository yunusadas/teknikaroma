...
?>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-3 animated slideInDown"><?php echo $tr["about_title"]; ?></h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a class="text-body" href="#"><?php echo $tr["aboutsublink_1"]; ?></a></li>
                    <li class="breadcrumb-item"><a class="text-body" href="#"><?php echo $tr["aboutsublink_2"]; ?></a></li>
                    <li class="breadcrumb-item text-dark active" aria-current="page"><?php echo $tr["aboutsublink_3"]; ?></li>
                </ol>
            </nav>
        </div>
    </div>
